...
{
	addSource(points, points1Distance, points1Amplitude, points1Frequency, flag1, counter1);
}

void GUIMyFrame::on_addSource2Click(wxCommandEvent& event)
{
	addSource(points, points2Distance, points2Amplitude, points2Frequency, flag2, counter2);
}
